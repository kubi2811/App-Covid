 ...
 * @author ranco
 */
public class DangNhapFirst extends javax.swing.JFrame {

    /**
     * Creates new form DangNhapFirst
     */
    public DangNhapFirst() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbQuyenTruyCap.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin" }));
        ...
        jLabel1.setText("Đăng ký Admin hệ thống");
...
//            String sql = "INSERT INTO TaiKhoan VALUES (?, ?, ?, ?)";
            ...
            pre.setString(6, option);
            rs = pre.executeQuery();
            
//            String sql2 = "INSERT INTO TaiKhoan VALUES (?, ?, null, null)";
//            pre = conn.prepareStatement(sql2);
//            pre.setString(1, username);
//            pre.setString(2, username);
//            pre.setString(3, pass);
//            pre.setString(4, option);
//            rs = pre.executeQuery();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DangNhapFirst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
